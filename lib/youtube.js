...
var Youtube = (function(){
  ...
  youtube.prototype.makeGet = function(params){
    ...
    var httpOpts = {
      ...
      path: "/youtube/v3/videos" + (typeof(params) != "undefined" ? "?" + querystring.stringify(params) : "")
    };
    return httpOpts;
  };
    ...
    for (key in videoData) {
      ...
      if(typeof video !== 'undefined') {
        ...
        if(typeof video.id !== 'undefined') {
          ...
          result.id = video.id;
          // Get the URL
          result.url = 'https://youtube.com/watch?v=' + video.id;
        }
        else continue;
  ...
  youtube.prototype.query = function(query, callback){
    ...
    var httpOpts = this.makeGet({
      ...
      chart: 'mostPopular', // Arbitrary but required
